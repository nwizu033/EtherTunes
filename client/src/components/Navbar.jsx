...
const Navbar = () => {
	...
	return (
		<div className=' w-full  shadow-lg '>
				...
				<IconContext.Provider value={{ color: "#fff" }}>
					{isMobile ? (
						...
						<div className=' flex items-center ml-auto justify-between '>
							...
							<div className=' flex ml-20 bg-green-700 items-center self-center rounded-lg mt-1 hover:bg-green-800 '>
								<button className=' bottom-1 px-4 py-2 '>Connect Wallet</button>
							</div>
						</div>
					)}
			...
			{showMenu && (
				<div className=' absolute top-[84px] rounded-lg right-1 left-1 pb-10 z-30 bg-gray-900/90 flex flex-col justify-between '>
